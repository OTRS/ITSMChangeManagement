...
sub Data {
    ...
    $Self->{Translation}->{'Edit Template Content'} = 'Ubah isi template';
    $Self->{Translation}->{'Delete Template'} = 'Hapus template';
    ...
    $Self->{Translation}->{'Dynamic fields (for changes and workorders) shown in the change print screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled.'} =
        'bidang dinamis (untuk perubahan dan perintah kerja) yang ditampilkan di layar perubahan cetak dari antarmuka agen. pengaturan mungkin: 0 = Non-aktif, 1 = Diaktifkan.';
    $Self->{Translation}->{'Dynamic fields shown in the change add screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.'} =
        'bidang dinamis ditampilkan dalam perubahan menambahkan layar antarmuka agen. pengaturan mungkin: 0 = Non aktif, 1 = Aktifkan, 2 = Aktifkan dan diperlukan.';
    $Self->{Translation}->{'Dynamic fields shown in the change edit screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.'} =
        'bidang dinamis ditampilkan di layar perubahan mengedit antarmuka agen. pengaturan mungkin: 0 = Non aktif, 1 = Aktif, 2 = Aktifkan dan diperlukan.';
    $Self->{Translation}->{'Dynamic fields shown in the change search screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled.'} =
        'bidang dinamis ditampilkan di layar perubahan pencarian dari antarmuka agen. pengaturan mungkin: 0 = Non aktif, 1 = Diaktifkan.';
    $Self->{Translation}->{'Dynamic fields shown in the change zoom screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled.'} =
        'bidang dinamis ditampilkan di layar perubahan zoom dari antarmuka agen. pengaturan mungkin: 0 = Non aktif, 1 = Diaktifkan.';
    $Self->{Translation}->{'Dynamic fields shown in the workorder add screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.'} =
        'bidang dinamis ditampilkan dalam urutan kerja menambahkan layar antarmuka agen. pengaturan mungkin: 0 = Non aktif, 1 = Aktifkan, 2 = Aktifkan dan diperlukan.';
    $Self->{Translation}->{'Dynamic fields shown in the workorder edit screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.'} =
        'bidang dinamis ditampilkan dalam urutan kerja mengedit layar antarmuka agen. pengaturan mungkin: 0 =Non aktif, 1 = Aktifkan, 2 = Aktifkan dan diperlukan.';
    $Self->{Translation}->{'Dynamic fields shown in the workorder report screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.'} =
        'bidang dinamis ditampilkan dalam urutan kerja layar laporan dari antarmuka agen. pengaturan mungkin: 0 = Non aktif, 1 = Aktifkan, 2 = Aktifkan dan diperlukan.';
    $Self->{Translation}->{'Dynamic fields shown in the workorder zoom screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled.'} =
        'bidang dinamis ditampilkan di layar zoom perintah kerja dari interface agen. pengaturan mungkin: 0 = Tidak diaktifkan, 1 = Diaktifkan.';
    ...
    $Self->{Translation}->{'Logfile for the ITSM change counter. This file is used for creating the change numbers.'} =
        'Log file untuk counter perubahan ITSM. File ini digunakan untuk membuat angka perubahan.';
