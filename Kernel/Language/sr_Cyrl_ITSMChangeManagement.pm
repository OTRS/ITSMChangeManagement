...
sub Data {
    ...
    $Self->{Translation}->{'Edit Template Content'} = 'Уреди садржај шаблона';
    $Self->{Translation}->{'Delete Template'} = 'Обриши шаблон';
    ...
    $Self->{Translation}->{'Dynamic fields (for changes and workorders) shown in the change print screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled.'} =
        'Динамичка поља (за промене и радне налоге) приказана на екрану штампе промене у интерфејсу оператера. Могућа подешавања: 0 = Онемогућено, 1 = Омогућено.';
    $Self->{Translation}->{'Dynamic fields shown in the change add screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.'} =
        'Динамичка поља приказана на екрану додавања промене у интерфејсу оператера. Могућа подешавања: 0 = Онемогућено, 1 = Омогућено, 2 = Омогућено и неопходно.';
    $Self->{Translation}->{'Dynamic fields shown in the change edit screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.'} =
        'Динамичка поља приказана на екрану измене промене у интерфејсу оператера. Могућа подешавања: 0 = Онемогућено, 1 = Омогућено, 2 = Омогућено и неопходно.';
    $Self->{Translation}->{'Dynamic fields shown in the change search screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled.'} =
        'Динамичка поља приказана на екрану претраге промене у интерфејсу оператера. Могућа подешавања: 0 = Онемогућено, 1 = Омогућено.';
    $Self->{Translation}->{'Dynamic fields shown in the change zoom screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled.'} =
        'Динамичка поља приказана на екрану детаљног приказа промене у интерфејсу оператера. Могућа подешавања: 0 = Онемогућено, 1 = Омогућено.';
    $Self->{Translation}->{'Dynamic fields shown in the workorder add screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.'} =
        'Динамичка поља приказана на екрану додавања радног налога у интерфејсу оператера. Могућа подешавања: 0 = Онемогућено, 1 = Омогућено, 2 = Омогућено и неопходно.';
    $Self->{Translation}->{'Dynamic fields shown in the workorder edit screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.'} =
        'Динамичка поља приказана на екрану измене радног налога у интерфејсу оператера. Могућа подешавања: 0 = Онемогућено, 1 = Омогућено, 2 = Омогућено и неопходно.';
    $Self->{Translation}->{'Dynamic fields shown in the workorder report screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.'} =
        'Динамичка поља приказана на екрану извештаја радног налога у интерфејсу оператера. Могућа подешавања: 0 = Онемогућено, 1 = Омогућено, 2 = Омогућено и неопходно.';
    $Self->{Translation}->{'Dynamic fields shown in the workorder zoom screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled.'} =
        'Динамичка поља приказана на екрану детаљног приказа радног налога у интерфејсу оператера. Могућа подешавања: 0 = Онемогућено, 1 = Омогућено.';
    ...
    $Self->{Translation}->{'Logfile for the ITSM change counter. This file is used for creating the change numbers.'} =
        'Датотека дневника за „ITSM” бројач промена. Ова дадтотека се користи за генерисање броја промене.';
