...
sub Data {
    ...
    $Self->{Translation}->{'Rule'} = 'บทบาทหน้าที่';
    ...
    $Self->{Translation}->{'Edit Template Content'} = 'แก้ไขแม่แบบของเนื้อหา';
    $Self->{Translation}->{'Delete Template'} = 'ลบแม่แบบ';
    ...
    $Self->{Translation}->{'Dynamic fields (for changes and workorders) shown in the change print screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled.'} =
        'ฟิลด์แบบไดนามิก (สำหรับการเปลี่ยนแปลงและใบสั่งงาน) ที่แสดงในหน้าจอการพิมพ์การเปลี่ยนแปลงของอินเตอร์เฟซเอเย่นต์ การตั้งค่าที่เป็นไปได้: 0 =ปิดใช้งาน 1 = เปิดใช้งาน';
    $Self->{Translation}->{'Dynamic fields shown in the change add screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.'} =
        'ฟิลด์แบบไดนามิกที่แสดงในหน้าจอการเพิ่มการเปลี่ยนแปลงของอินเตอร์เฟซเอเย่นต์ การตั้งค่าที่เป็นไปได้: 0 =ปิดใช้งาน 1 = เปิดใช้งาน 2 = เปิดใช้งานและจำเป็นต้องใช้';
    $Self->{Translation}->{'Dynamic fields shown in the change edit screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.'} =
        'ฟิลด์แบบไดนามิกที่แสดงในหน้าจอการแก้ไขการเปลี่ยนแปลงของอินเตอร์เฟซเอเย่นต์ การตั้งค่าที่เป็นไปได้: 0 =ปิดใช้งาน 1 = เปิดใช้งาน 2 = เปิดใช้งานและจำเป็นต้องใช้';
    $Self->{Translation}->{'Dynamic fields shown in the change search screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled.'} =
        'ฟิลด์แบบไดนามิกที่แสดงในหน้าจอการค้นหาการเปลี่ยนแปลงของอินเตอร์เฟซเอเย่นต์ การตั้งค่าที่เป็นไปได้: 0 =ปิดใช้งาน 1 = เปิดใช้งาน';
    $Self->{Translation}->{'Dynamic fields shown in the change zoom screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled.'} =
        'ฟิลด์แบบไดนามิกที่แสดงในหน้าจอการซูมการเปลี่ยนแปลงของอินเตอร์เฟซเอเย่นต์ การตั้งค่าที่เป็นไปได้: 0 =ปิดใช้งาน 1 = เปิดใช้งาน ';
    $Self->{Translation}->{'Dynamic fields shown in the workorder add screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.'} =
        'ฟิลด์แบบไดนามิกที่แสดงในหน้าจอการเพิ่มใบสั่งงานของอินเตอร์เฟซเอเย่นต์ การตั้งค่าที่เป็นไปได้: 0 =ปิดใช้งาน 1 = เปิดใช้งาน';
    $Self->{Translation}->{'Dynamic fields shown in the workorder edit screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.'} =
        'ฟิลด์แบบไดนามิกที่แสดงในหน้าจอการแก้ไขใบสั่งงานของอินเตอร์เฟซเอเย่นต์ การตั้งค่าที่เป็นไปได้: 0 =ปิดใช้งาน 1 = เปิดใช้งาน ';
    $Self->{Translation}->{'Dynamic fields shown in the workorder report screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.'} =
        'ฟิลด์แบบไดนามิกที่แสดงในหน้าจอรายงานใบสั่งงานของอินเตอร์เฟซเอเย่นต์ การตั้งค่าที่เป็นไปได้: 0 =ปิดใช้งาน 1 = เปิดใช้งาน ';
    $Self->{Translation}->{'Dynamic fields shown in the workorder zoom screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled.'} =
        'ฟิลด์แบบไดนามิกที่แสดงในหน้าจอการซูมใบสั่งงานของอินเตอร์เฟซเอเย่นต์ การตั้งค่าที่เป็นไปได้: 0 =ปิดใช้งาน 1 = เปิดใช้งาน ';
    ...
    $Self->{Translation}->{'Logfile for the ITSM change counter. This file is used for creating the change numbers.'} =
        'logfile สำหรับตัวนับการเปลี่ยนแปลง ITSM ไฟล์นี้จะใช้ในการสร้างหมายเลขการเปลี่ยนแปลง';
