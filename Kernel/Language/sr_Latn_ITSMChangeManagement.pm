...
sub Data {
    ...
    $Self->{Translation}->{'Edit Template Content'} = 'Uredi sadržaj šablona';
    $Self->{Translation}->{'Delete Template'} = 'Obriši šablon';
    ...
    $Self->{Translation}->{'Dynamic fields (for changes and workorders) shown in the change print screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled.'} =
        'Dinamička polja (za promene i radne naloge) prikazana na ekranu štampe promene u interfejsu operatera. Moguća podešavanja: 0 = Onemogućeno, 1 = Omogućeno.';
    $Self->{Translation}->{'Dynamic fields shown in the change add screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.'} =
        'Dinamička polja prikazana na ekranu dodavanja promene u interfejsu operatera. Moguća podešavanja: 0 = Onemogućeno, 1 = Omogućeno, 2 = Omogućeno i neophodno.';
    $Self->{Translation}->{'Dynamic fields shown in the change edit screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.'} =
        'Dinamička polja prikazana na ekranu izmene promene u interfejsu operatera. Moguća podešavanja: 0 = Onemogućeno, 1 = Omogućeno, 2 = Omogućeno i neophodno.';
    $Self->{Translation}->{'Dynamic fields shown in the change search screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled.'} =
        'Dinamička polja prikazana na ekranu pretrage promene u interfejsu operatera. Moguća podešavanja: 0 = Onemogućeno, 1 = Omogućeno.';
    $Self->{Translation}->{'Dynamic fields shown in the change zoom screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled.'} =
        'Dinamička polja prikazana na ekranu detaljnog prikaza promene u interfejsu operatera. Moguća podešavanja: 0 = Onemogućeno, 1 = Omogućeno.';
    $Self->{Translation}->{'Dynamic fields shown in the workorder add screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.'} =
        'Dinamička polja prikazana na ekranu dodavanja radnog naloga u interfejsu operatera. Moguća podešavanja: 0 = Onemogućeno, 1 = Omogućeno, 2 = Omogućeno i neophodno.';
    $Self->{Translation}->{'Dynamic fields shown in the workorder edit screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.'} =
        'Dinamička polja prikazana na ekranu izmene radnog naloga u interfejsu operatera. Moguća podešavanja: 0 = Onemogućeno, 1 = Omogućeno, 2 = Omogućeno i neophodno.';
    $Self->{Translation}->{'Dynamic fields shown in the workorder report screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.'} =
        'Dinamička polja prikazana na ekranu izveštaja radnog naloga u interfejsu operatera. Moguća podešavanja: 0 = Onemogućeno, 1 = Omogućeno, 2 = Omogućeno i neophodno.';
    $Self->{Translation}->{'Dynamic fields shown in the workorder zoom screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled.'} =
        'Dinamička polja prikazana na ekranu detaljnog prikaza radnog naloga u interfejsu operatera. Moguća podešavanja: 0 = Onemogućeno, 1 = Omogućeno.';
    ...
    $Self->{Translation}->{'Logfile for the ITSM change counter. This file is used for creating the change numbers.'} =
        'Datoteka dnevnika za „ITSM” brojač promena. Ova dadtoteka se koristi za generisanje broja promene.';
