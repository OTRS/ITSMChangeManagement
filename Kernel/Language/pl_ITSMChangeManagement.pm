...
# --
# $Id: pl_ITSMChangeManagement.pm,v 1.1.2.1 2011-12-19 16:18:04 ub Exp $
# --
...
sub Data {
    ...
    $Self->{Translation}->{'A change must have a title!'} = 'Zmiana musi posiadaæ tytu³!';
    $Self->{Translation}->{'A condition must have a name!'} = 'Warunek musi posiadañ nazwê!';
    $Self->{Translation}->{'A template must have a name!'} = 'Szablon musi posiadaæ nazwê!';
    $Self->{Translation}->{'A workorder must have a title!'} = 'Zadanie musi posiadaæ tytu³!';
    $Self->{Translation}->{'ActionExecute::successfully'} = 'pomy¶lnie';
    $Self->{Translation}->{'ActionExecute::unsuccessfully'} = 'niepomy¶lnie';
    ...
    $Self->{Translation}->{'Add new condition and action pair'} = 'Dodaj now± parê warunek-akcja';
    $Self->{Translation}->{'Agent interface module to show the ChangeManager overview icon.'} = 'Modu³ interfejsu agenta do wy¶wietlania ikony przegl±du Manager zmiany.';
    $Self->{Translation}->{'Agent interface module to show the MyCAB overview icon.'} = 'Modu³ interfejsu agenta do wy¶wietlania ikony przegl±du Moje CAB.';
    $Self->{Translation}->{'Agent interface module to show the MyChanges overview icon.'} = 'Modu³ interfejsu agenta do wy¶wietlania ikony przegl±du Moje zmiany.';
    $Self->{Translation}->{'Agent interface module to show the MyWorkOrders overview icon.'} = 'Modu³ interfejsu agenta do wy¶wietlania ikony przegl±du Moje zadania.';
    $Self->{Translation}->{'CABAgents'} = 'CAB Agenci';
    $Self->{Translation}->{'CABCustomers'} = 'CAB Klienci';
    $Self->{Translation}->{'Change Overview'} = 'Przegl±d zmiany';
    $Self->{Translation}->{'Change Schedule'} = 'Harmonogram zmiany';
    $Self->{Translation}->{'Change involved persons of the change'} = 'Zmieñ osoby zaanga¿owane w zmianê';
    $Self->{Translation}->{'ChangeHistory::ActionAdd'} = '%s: %s';
    $Self->{Translation}->{'ChangeHistory::ActionAddID'} = 'Nowa akcja (ID=%s)';
    $Self->{Translation}->{'ChangeHistory::ActionDelete'} = 'Akcja (ID=%s) usuniêta';
    $Self->{Translation}->{'ChangeHistory::ActionDeleteAll'} = 'Wszystkie akcje warunku (ID=%s) usuniête';
    ...
    $Self->{Translation}->{'ChangeHistory::ChangeActualEndTimeReached'} = 'Zmiana (ID=%s) osi±gnê³a rzeczywisty czas koñca.';
    $Self->{Translation}->{'ChangeHistory::ChangeActualStartTimeReached'} = 'Zmiana (ID=%s) osi±gnê³a rzeczywisty czas startu.';
    $Self->{Translation}->{'ChangeHistory::ChangeAdd'} = 'Nowa zmiana (ID=%s)';
    $Self->{Translation}->{'ChangeHistory::ChangeAttachmentAdd'} = 'Nowy za³±cznik: %s';
    $Self->{Translation}->{'ChangeHistory::ChangeAttachmentDelete'} = 'Usuniêty za³±cznik %s';
    $Self->{Translation}->{'ChangeHistory::ChangeCABDelete'} = 'CAB usuniêto %s';
    $Self->{Translation}->{'ChangeHistory::ChangeCABUpdate'} = '%s: Nowe: %s <- Stare: %s';
    $Self->{Translation}->{'ChangeHistory::ChangeLinkAdd'} = 'Utworzony odno¶nik do %s (ID=%s)';
    $Self->{Translation}->{'ChangeHistory::ChangeLinkDelete'} = 'Usuniêty odno¶nik do %s (ID=%s)';
    $Self->{Translation}->{'ChangeHistory::ChangeNotificationSent'} = 'Powiadomienie wys³ane do %s (Zdarzenie: %s)';
    $Self->{Translation}->{'ChangeHistory::ChangePlannedEndTimeReached'} = 'Zmiana (ID=%s) osi±gnê³a planowany czas koñca.';
    $Self->{Translation}->{'ChangeHistory::ChangePlannedStartTimeReached'} = 'Zmiana (ID=%s) osi±gnê³a planowany czas startu.';
    $Self->{Translation}->{'ChangeHistory::ChangeRequestedTimeReached'} = 'Zmiana (ID=%s) osi±gnê³a ¿±dany czas.';
    ...
    $Self->{Translation}->{'ChangeHistory::ConditionDelete'} = 'Warunek (ID=%s) usuniêty';
    $Self->{Translation}->{'ChangeHistory::ConditionDeleteAll'} = 'Wszsytkie warunki w zmianie (ID=%s) usuniête';
    ...
    $Self->{Translation}->{'ChangeHistory::ExpressionAddID'} = 'Nowe wyra¿enie (ID=%s)';
    $Self->{Translation}->{'ChangeHistory::ExpressionDelete'} = 'Wyra¿enie (ID=%s) usuniête';
    $Self->{Translation}->{'ChangeHistory::ExpressionDeleteAll'} = 'Wszystkie wyra¿enia w warunku (ID=%s) usuniête';
    $Self->{Translation}->{'ChangeHistory::ExpressionUpdate'} = '%s (Wyra¿enie ID=%s): Nowe: %s <- Stare: %s';
    $Self->{Translation}->{'ChangeNumber'} = 'Numer zmiany';
    $Self->{Translation}->{'Clear'} = 'Wyczy¶æ';
    $Self->{Translation}->{'Condition Edit'} = 'Edycja warunku';
    $Self->{Translation}->{'Conditions'} = 'Warunki';
    $Self->{Translation}->{'Create Change'} = 'Utwórz zmianê';
    $Self->{Translation}->{'Create a change from this ticket!'} = 'Utwórz zmianê z tego zg³oszenia!';
    $Self->{Translation}->{'Delete Workorder'} = 'Usuñ zadanie';
    $Self->{Translation}->{'Edit the change'} = 'Edytuj zmianê';
    ...
    $Self->{Translation}->{'Expression'} = 'Wyra¿enie';
    $Self->{Translation}->{'Full-Text Search in Change and Workorder'} = 'Wyszukiwanie pe³notekstowe w zmianie i zadaniach';
    $Self->{Translation}->{'ITSMCondition'} = 'Warunek';
    $Self->{Translation}->{'ITSMWorkOrder'} = 'Zadanie';
    $Self->{Translation}->{'Link another object to the change'} = 'Po³±cz zmianê z innym obiektem';
    $Self->{Translation}->{'Link another object to the workorder'} = 'Po³±cz zadanie z innym obiektem';
    $Self->{Translation}->{'Move all workorders in time'} = 'Przesuñ wszystkie zadania w czasie';
    $Self->{Translation}->{'My CABs'} = 'Moje CABy';
    $Self->{Translation}->{'My Changes'} = 'Moje zmiany';
    $Self->{Translation}->{'My Workorders'} = 'Moje zadania';
    $Self->{Translation}->{'No XXX settings'} = 'Brak ustawieñ \'%s\'';
    ...
    $Self->{Translation}->{'Please select first a catalog class!'} = 'Zaznacz najpierw proszê klasê z katalogu!';
    $Self->{Translation}->{'Print the change'} = 'Wydrukuj zmianê';
    $Self->{Translation}->{'Print the workorder'} = 'Wydrukuj zadanie';
    $Self->{Translation}->{'RequestedTime'} = '¯±dany czas';
    $Self->{Translation}->{'Save Change CAB as Template'} = 'Zapisz CAB jako szablon';
    $Self->{Translation}->{'Save change as a template'} = 'Zapisz zmianê jako szablon';
    ...
    $Self->{Translation}->{'Take Workorder'} = 'We¼ zadanie';
    $Self->{Translation}->{'Take the workorder'} = 'We¼ zadanie';
    $Self->{Translation}->{'Template Overview'} = 'Przegl±d szablonu';
    $Self->{Translation}->{'Templates'} = 'Szablony';
    $Self->{Translation}->{'The planned end time is invalid!'} = 'Planowany czas koñca jest niepoprawny!';
    $Self->{Translation}->{'The planned start time is invalid!'} = 'Planowany czas rozpoczêcia jest niepoprawny!';
    $Self->{Translation}->{'The planned time is invalid!'} = 'Planowany czas jest niepoprawny!';
    $Self->{Translation}->{'The requested time is invalid!'} = '¯±dany czas jest niepoprawny!';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderActualEndTimeReached'} = 'Zadanie (ID=%s) osi±gnê³o rzeczywisty czas koñca.';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderActualEndTimeReachedWithWorkOrderID'} = 'Zadanie (ID=%s) osi±gnê³o rzeczywisty czas koñca.';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderActualStartTimeReached'} = 'Zadanie (ID=%s) osi±gnê³o rzeczywisty czas startu.';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderActualStartTimeReachedWithWorkOrderID'} = 'Zadanie (ID=%s) osi±gnê³o rzeczywisty czas startu.';
    ...
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderAttachmentAdd'} = '(ID=%s) Nowy za³±cznik do zadania: %s';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderAttachmentAddWithWorkOrderID'} = '(ID=%s) Nowy za³±cznik do zadania: %s';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderAttachmentDelete'} = 'Usuniêty za³±cznik z zadania: %s';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderAttachmentDeleteWithWorkOrderID'} = '(ID=%s) Usuniêty za³±cznik z zadania: %s';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderDelete'} = 'Zadanie (ID=%s) usuniête';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderDeleteWithWorkOrderID'} = 'Zadanie (ID=%s) usuniête';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderLinkAdd'} = 'Utworzony odno¶nik do %s (ID=%s)';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderLinkAddWithWorkOrderID'} = '(ID=%s) Utworzony odno¶nik do %s (ID=%s)';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderLinkDelete'} = 'Usyniêty odno¶nik do %s (ID=%s)';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderLinkDeleteWithWorkOrderID'} = '(ID=%s) Usuniêty odno¶nik do %s (ID=%s)';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderNotificationSent'} = 'Powiadomienie wys³ane do %s (Zdarzenie: %s)';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderNotificationSentWithWorkOrderID'} = '(ID=%s) Powiadomienie wys³ane do %s (Zdarzenie: %s)';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderPlannedEndTimeReached'} = 'Zadanie (ID=%s) osi±gnê³o planowany czas koñca.';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderPlannedEndTimeReachedWithWorkOrderID'} = 'Zadanie (ID=%s) osi±gnê³o planowany czas koñca.';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderPlannedStartTimeReached'} = 'Zadanie (ID=%s) osi±gnê³o planowany czas startu.';
    $Self->{Translation}->{'WorkOrderHistory::WorkOrderPlannedStartTimeReachedWithWorkOrderID'} = 'Zadanie (ID=%s) osi±gnê³o planowany czas startu.';
    ...
    $Self->{Translation}->{'begins with'} = 'zaczyna siê od';
    ...
    $Self->{Translation}->{'pending decision'} = 'czeka na decyzjê';
    $Self->{Translation}->{'ends with'} = 'koñczy siê na';
    $Self->{Translation}->{'failed'} = 'zakoñczone niepomy¶lnie';
    ...
    $Self->{Translation}->{'is greater than'} = 'jest wiêksze od';
    ...
    $Self->{Translation}->{'pending approval'} = 'czeka na zgodê';
    $Self->{Translation}->{'pending pir'} = 'czeka na recenzjê (PIR)';
    $Self->{Translation}->{'pir'} = 'recenzja (PIR)';
    $Self->{Translation}->{'ready'} = 'gotowe';
    $Self->{Translation}->{'rejected'} = 'odrzucone';
    $Self->{Translation}->{'requested'} = '¿±danie';
    $Self->{Translation}->{'retracted'} = 'wycofane';
    $Self->{Translation}->{'set'} = 'ustaw';
    $Self->{Translation}->{'successful'} = 'zakoñczone pomy¶lnie';

    # Template: AdminITSMChangeCIPAllocate
    $Self->{Translation}->{'Category <-> Impact <-> Priority'} = 'Kategoria <-> Wp³yw <-> Priorytet';
    $Self->{Translation}->{'Manage the priority result of combinating Category <-> Impact.'} = 'Zarz±dzanie priorytetem dla kombinacji Kategoria <-> Wp³yw.';
    $Self->{Translation}->{'Priority allocation'} = 'Alokacja priorytetu';

    # Template: AdminITSMChangeNotification
    $Self->{Translation}->{'ITSM ChangeManagement Notification Management'} = 'Zarz±dzanie powiadomieniami zmian ITSM';
    $Self->{Translation}->{'Add Notification Rule'} = 'Dodaj regu³ê powiadamiania';
    $Self->{Translation}->{'Rule'} = 'Regu³a';
    $Self->{Translation}->{'A notification should have a name!'} = 'Powiadomiene powinno mieæ nazwê!';
    $Self->{Translation}->{'Name is required.'} = 'Nazwa jest wymagana.';

    # Template: AdminITSMStateMachine
    $Self->{Translation}->{'Admin State Machine'} = 'Zarz±daj maszyn± stanów';
    $Self->{Translation}->{'Select a catalog class!'} = 'Zaznacz klasê katalogu!';
    $Self->{Translation}->{'A catalog class is required!'} = 'Klasa katalogu jest wymagana!';
    $Self->{Translation}->{'Add a state transition'} = 'Dodaj przej¶cie miêdzy stanami';
    $Self->{Translation}->{'Catalog Class'} = 'Klasa katalogu';
    $Self->{Translation}->{'Object Name'} = 'Nazwa obiektu';
    $Self->{Translation}->{'Overview over state transitions for'} = 'Przegl±d przej¶æ stanów dla';
    $Self->{Translation}->{'Add a new state transition for'} = 'Dodaj nowe przej¶cie stanu dla';
    $Self->{Translation}->{'Please select a state!'} = 'Zaznacz stan!';
    $Self->{Translation}->{'Please select a next state!'} = 'Zaznacz nastêpny stan!';
    $Self->{Translation}->{'Edit a state transition for'} = 'Edytuj przej¶cie stanu dla';
    $Self->{Translation}->{'Do you really want to delete the state transition'} = 'Czy na pewno chcesz usun±æ przej¶cie stanu';
    ...
    $Self->{Translation}->{'Add Change'} = 'Dodaj zmianê';
    ...
    $Self->{Translation}->{'Input invalid.'} = 'Niepoprawne dane wej¶ciowe.';
    $Self->{Translation}->{'Impact'} = 'Wp³yw';
    $Self->{Translation}->{'Requested Date'} = '¯±dana data';

    # Template: AgentITSMChangeCABTemplate
    $Self->{Translation}->{'Save Change CAB as template'} = 'Zapisz CAB zmiany jako szablon';
    $Self->{Translation}->{'go to involved persons screen'} = 'id¼ do ekranu z osobami zaanga¿owanymi';
    ...
    $Self->{Translation}->{'Delete Condition'} = 'Usuñ warunek';
    ...
    $Self->{Translation}->{'Any expression (OR)'} = 'Dowolne wyra¿enie (OR)';
    $Self->{Translation}->{'All expressions (AND)'} = 'Wszystkie wyra¿enia (AND)';
    $Self->{Translation}->{'Expressions'} = 'Wyra¿enia';
    $Self->{Translation}->{'Selector'} = 'Selektor';
    $Self->{Translation}->{'Operator'} = 'Operator';
    $Self->{Translation}->{'No Expressions found.'} = 'Nie znaleziono wyra¿eñ.';
    $Self->{Translation}->{'Add new expression'} = 'Dodaj nowe wyra¿enie';
    $Self->{Translation}->{'No Actions found.'} = 'Nie znaleziono akcji.';
    $Self->{Translation}->{'Add new action'} = 'Dodaj now± akcjê';
    ...
    $Self->{Translation}->{'Workorder'} = 'Zadanie';
    $Self->{Translation}->{'Show details'} = 'Poka¿ szczegó³y';
    $Self->{Translation}->{'Show workorder'} = 'Poka¿ zadanie';

    # Template: AgentITSMChangeHistoryZoom
    $Self->{Translation}->{'Detailed history information of'} = 'Szczegó³owe informacji o historii';
    $Self->{Translation}->{'Old Value'} = 'Stara warto¶æ';
    $Self->{Translation}->{'New Value'} = 'Nowa warto¶æ';

    # Template: AgentITSMChangeInvolvedPersons
    $Self->{Translation}->{'Involved Persons'} = 'Zaanga¿owane osoby';
    $Self->{Translation}->{'ChangeManager'} = 'Manager zmiany';
    $Self->{Translation}->{'User invalid.'} = 'Niepoprawny u¿ytkownik.';
    ...
    $Self->{Translation}->{'Invalid User'} = 'Niepoprawny u¿ytkownik';
    ...
    $Self->{Translation}->{'Changes per page'} = 'Zmiany na stronê';

    # Template: AgentITSMChangeOverviewSmall
    $Self->{Translation}->{'WorkOrderTitle'} = 'Tytu³ zadania';
    $Self->{Translation}->{'ChangeTitle'} = 'Tytu³ zmiany';
    ...
    $Self->{Translation}->{'Requested Time'} = '¯±dany czas';
    ...
    $Self->{Translation}->{'Change Category'} = 'Zmieñ kategoriê';
    $Self->{Translation}->{'(before/after)'} = '(przed/po)';
    $Self->{Translation}->{'(between)'} = '(pomiêdzy)';

    # Template: AgentITSMChangeSearchResultPrint
    $Self->{Translation}->{'WorkOrders'} = 'Zadania';

    # Template: AgentITSMChangeTemplate
    $Self->{Translation}->{'Save Change as Template'} = 'Zapisz zmianê jako szablon';
    $Self->{Translation}->{'A template should have a name!'} = 'Szablon powinien mieæ nazwê!';
    ...
    $Self->{Translation}->{'Move Time Slot'} = 'Przesuñ przedzia³ czasu';

    # Template: AgentITSMChangeZoom
    $Self->{Translation}->{'Change Information'} = 'Informacje o zmianie';
    $Self->{Translation}->{'PlannedEffort'} = 'Planowany wysi³ek';
    ...
    $Self->{Translation}->{'Show or hide the content.'} = 'Poka¿ lub ukryj zawarto¶æ.';
    $Self->{Translation}->{'Download Attachment'} = 'Pobierz za³±cznik';

    # Template: AgentITSMTemplateDelete
    $Self->{Translation}->{'Do you really want to delete this template?'} = 'Czy na pewno chcesz usun±æ ten szablon?';
    ...
    $Self->{Translation}->{'Delete: '} = 'Usuniêcie: ';
    ...
    $Self->{Translation}->{'Select Workorder Template'} = 'Wska¿ szablon zadania';
    $Self->{Translation}->{'Invalid workorder type.'} = 'Nieprawid³owy typ zadania.';
    $Self->{Translation}->{'The planned start time must be before the planned end time!'} = 'Planowany czas startu musi byæ przed planowanym czasem koñca!';
    $Self->{Translation}->{'Invalid format.'} = 'Nieprawid³owy format.';

    # Template: AgentITSMWorkOrderAgent

    # Template: AgentITSMWorkOrderDelete
    $Self->{Translation}->{'Do you really want to delete this workorder?'} = 'Czy na pewno chcesz usun±æ to zadanie?';
    $Self->{Translation}->{'You can not delete this Workorder. It is used in at least one Condition!'} = 'Nie mo¿esz usun±æ tego zadania. Jest ono u¿ywane w przynajmniej jednym warunku!';
    $Self->{Translation}->{'This Workorder is used in the following Condition(s)'} = 'To zadanie jest u¿ywane w nastêpuj±cych warunkach';
    ...
    $Self->{Translation}->{'The actual start time must be before the actual end time!'} = 'Rzeczywisty czas startu musi byæ przed rzecztwistym czasem koñca!';
    $Self->{Translation}->{'The actual start time must be set, when the actual end time is set!'} = 'Rzeczywisty czas startu musi byæ ustawiony gdy ustawiony jest rzeczywisty czas koñca!';

    # Template: AgentITSMWorkOrderTake
    $Self->{Translation}->{'Current Agent'} = 'Aktualny agent';
    $Self->{Translation}->{'Do you really want to take this workorder?'} = 'Czy na pewno chcesz wzi±æ to zadanie?';
    ...
    $Self->{Translation}->{'Admin of notification rules.'} = 'Administracja regu³ami powiadomieñ';
    $Self->{Translation}->{'Admin of the CIP matrix.'} = 'Zarz±dzanie macierz± KWP';
    $Self->{Translation}->{'Admin of the state machine.'} = 'Zarz±dzanie maszyn± stanów';
    ...
    $Self->{Translation}->{'Cache time in minutes for the change management.'} = 'Czas cacheowania zmian w minutach.';
    $Self->{Translation}->{'Change Overview "Small" Limit'} = 'Limit przegl±du zmian "Ma³e"';
    ...
    $Self->{Translation}->{'Change limit per page for Change Overview "Small"'} = 'Limit zmian na stronie dla przegl±du zmian "Ma³e"';
